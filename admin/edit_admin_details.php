                            ...
                            <div class="module-body" >
                                ...
                                <form  class="form-horizontal row-fluid" action="edit_admin_details.php?id=<?php echo $rollno ?>" method="post">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" style="margin-right:30px;" for="Name"><b>:الاسم</b></label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="MobNo"><b>:رقم الهاتف</b></label>
                                        <div class="controls">
                                            <input type="text" id=""  style="text-align:right" name="MobNo" value= "<?php echo $mobno?>" class="span8" required>
                                        </div>
                                    </div>
...
echo "<script type='text/javascript'>alert('تم التعديل ينجاح')</script>";
