    ...
    <body>
        ...
        <nav aria-label="breadcrumb" style="margin-top: -30px;margin-left: 30px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="renew_requests.php"> طلبات التجديد </li>
            </ol>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <h1 style="float:right;text-align:right"><i>طلبات التجديد</i></h1>
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><center>
                                        <?php
                                        if($renewals > 0)
                                        {echo "<a href=\"acceptrenewal.php?id1=".$bookid."&id2=".$rollno."\" class=\"btn btn-success\">قبول</a>";}
                                         ?>
                                        <!--a href="rejectrenewal.php?id1=<?php echo $bookid; ?>&id2=<?php echo $rollno; ?>" class="btn btn-danger">رفض</a-->
                                    </center></td>
                                    </tr>
                               <?php } ?>
                               </tbody>
