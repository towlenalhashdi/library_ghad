                    ...
                    <div class="content"  >
                        ...
                        <div class="module">
                            ...
                            <div class="module-body" style="text-align:left;">
                                    ...
                                    <form class="form-horizontal row-fluid" action="message.php" id="frm_data"method="post">
                                        <div class="control-group">
                                            <label class="control-label" style="margin-right:30px;" for="Rollno"><b>:رقم الطالب المستلم</b></label>
                                            <div class="controls">
                                                <input type="text" id="RollNo" name="RollNo"   style="text-align:right;margin-right:50px;" placeholder="رقم المستلم" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" style="margin-right:30px;" for="Message"><b>:الرسالة</b></label>
                                            <div class="controls">
                                                <input type="text" id="Message" name="Message"  style="text-align:right;margin-right:50px;" placeholder="ادخل الرسالة" class="span8" required>
                                            </div>
                                            <hr>
                                        <div class="control-group">
                                            <div class="controls">
                                                <button type="submit"  id="notify"name="submit"class="btn">إضافة رسالة</button>
                                            </div>
                                        </div>
                                    </form>
                            </div>
...
$sql1="insert into LMS.message (RollNo,Msg,active,Date,Time) values ('$rollno','$message','1',curdate(),curtime())";

if($conn->query($sql1) === TRUE){
echo "<script type='text/javascript'>alert('تم ارسال الرسالة بنجاح')</script>";
}
else
{//echo $conn->error;
