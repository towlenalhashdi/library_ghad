    ...
    <body>
        ...
        <nav aria-label="breadcrumb" style="margin-top: -30px;margin-left: 30px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="requests.php">طلبات الارجاع /الارجاع  </li>
            </ol>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span3">
                        <center>
                            <a href="issue_requests.php" class="btn btn-info" ><image width="100px" src="images/book2.png"></image><p> طلبات الاعارة </p></a>
                        </center>
                    </div>
                    <div class="span3">
                        <center>
                            <a href="renew_requests.php" class="btn btn-info"><image width="100px" src="images/book3.png"></image><p> طلبات التجديد</p></a>
                        </center>
                    </div> 
                    <div class="span3">
                        <center>
                            <a href="return_requests.php" class="btn btn-info"><image width="100px" src="images/book4.png"></image><p> طلبات الارجاع</p></a>
                        </center>
                    </div>
                    <!--/.span3-->
                    <!--/.span9-->
