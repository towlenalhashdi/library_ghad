    ...
    <body>
        ...
        <nav aria-label="breadcrumb" style="margin-top: -30px;margin-left: 30px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current=""><a style="color:#1e7594;"href="book.php">كافة كتاب /</a></li>
                <li class="breadcrumb-item active" aria-current="edit_book_details.php">تعديل الكتاب </li>
            </ol>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9" style="text-align:left;" dir="rtl">
                        <div class="module">
                            <div class="module-head" style="text-align:right;">
                                <h3>تعديل بيانات الكتاب</h3>
                            </div>
                                ...
                                ?>
                                    ...
                                    <form class="form-horizontal row-fluid" action="edit_book_details.php?id=<?php echo $bookid ?>" method="post">
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Title">عنوان الكتاب:</label></b>
                                        ...
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Publisher">الناشر:</label></b>
                                            <div class="controls" style="text-align: right;">
                                        ...
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Year">السنة:</label></b>
                                            <div class="controls" style="text-align: right;">
                                        ...
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Availability"> الكتب المتوفرة:</label></b>
                                            <div class="controls" style="text-align:right;">
                                        ...
                                        <div class="control-group">
                                            <div class="controls" >
                                                <button type="submit" name="submit"class="btn">تعديل التفاصيل</button>
                                            </div>
                                        </div>
...
{//echo $conn->error;
echo "<script type='text/javascript'>alert('خطأ حاول مرة اخرى')</script>";
}
}
?>
