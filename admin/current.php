        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php" style="float:right;margin-right:-35px;
    "> نظام إدارة المكتبات <img src="../images/logo.png" width="60px" height="60px">  </a> 
        ...
        <nav aria-label="breadcrumb" style="margin-top: -30px;margin-left: 30px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="current.php">الكتب المستعارة حالياً </li>
            </ol>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div style="margin-left: 25px;margin-bottom: -35px;">  
                        ...
                        <form method="post" action="data_prant2.php" target="_new" class="form-inline">
                    ...
                    <div class="span9" style="float:left;margin-left:30px;">
                        <form class="form-horizontal row-fluid" action="current.php" method="post">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="title"  style="text-align:right" name="title" placeholder="ادخل رقم الطالب/اسم الكتاب/رقم الكتاب." class="span8" required>
                                    ...
                                    ?>
                        <table class="table" id = "tables" dir="rtl"style="text-align:right;" >
