    ...
    <body>
        ...
        <nav aria-label="breadcrumb" style="margin-top: -30px;margin-left: 30px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current=""><a style="color:#1e7594;"href="student.php"> ادارة الطلاب /</a></li>
                <li class="breadcrumb-item active" aria-current="studentdetails.php">تفاصيل الطالب </li>
            </ol>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9" style="float:left;margin-left:-1px;text-align:right;margin-top: -430px;" dir="rtl">
                        <div class="content">
                        ...
                        <?php
                            ...
                            $row=$result->fetch_assoc();    
                                ...
                                echo "<b ><u>الاسم:</u></b> ".$name."<br><br>";
                                echo "<b><u>الصنف:</u></b> ".$category."<br><br>";
                                echo "<b><u>رقم الطالب:</u></b> ".$rno."<br><br>";
                                echo "<b><u>البريد الالكتروني:</u></b> ".$email."<br><br>";
                                echo "<b><u>رقم الهاتف:</u></b> ".$mobno."<br><br>"; 
                            ?>
                            
                        <a href="student.php" class="btn btn-primary">رجوع</a>                             
                               </div>
                           </div>
                        </div>
                    </div>
