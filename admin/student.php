...
<html lang="en">
    ...
    <head>
        ...
        <title>نظام ادارة المكتبات </title><title>LMS</title>
        ...
        <script src="css/jquery-3.5.1.js" type="text/javascript"></script-->
    ...
    <body>
        ...
        <nav aria-label="breadcrumb" style="margin-top: -30px;margin-left: 30px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="student.php">ادارة الطلاب</li>
            </ol>
                    ...
                    <div class="span9" style="float:left;margin-left:30px;">
                        <form class="form-horizontal row-fluid" action="student.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="Search" style="margin-right:160px;margin-bottom:-30px;"><b>:البحــث</b></label>
                                            <div class="controls">
                                                <input type="text" id="title" style="text-align:right;" name="title" placeholder="ادخل اسم/رقم الطالب" class="span8" required>
                                                <button type="submit" name="submit"class="btn" style="margin-left:-540px;">بحث</button>
                                            </div>
                                        </div>
                                    </form>
                                    <br>
                                    ...
                                    ?>
                        <table class="table" id="tables"  dir="rtl" class="display">
                                  <thead style="text-align:right;">
                                    <tr>
                                      <th width="60px">الاسم</th>
                                      <th width="60px">رقم الطالب</th>
                                      <th width="60px">البريد الالكتروني</th>                                      
                                      <th width="60px"></th>
                                    </tr>
                                  </thead>
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><?php echo $email ?></td>                                      
                                        <td>
                                        <center>
                                            <a href="studentdetails.php?id=<?php echo $rollno; ?>" class="btn btn-success">تفاصيل</a>
                                            <a href="remove_student.php?id=<?php echo $rollno; ?>" class="btn btn-danger">حـذف</a>
                                      </center>
                                        </td>
                                    </tr>
                            <?php }} ?>
