    ...
    <body>
        ...
        <nav aria-label="breadcrumb" style="margin-top: -30px;margin-left: 30px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="bookdetails.php">تفاصيل الكتاب </li>
            </ol>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9"  style="text-align:right;" dir="rtl">
                        <div class="content">
                        ...
                        <?php
                            ...
                            $row=$result->fetch_assoc();    
                                ...
                                echo "<b>رقم الكتاب:</b> ".$bookid."<br><br>";
                                echo "<b>عنوان الكتاب:</b> ".$name."<br><br>";
                                ...
                                echo "<br><br>";
                                echo "<b>الناشر:</b> ".$publisher."<br><br>";
                                echo "<b>سنة النشر:</b> ".$year."<br><br>";
                                echo "<b>  الكتب المتوفرة::</b> ".$avail."<br><br>";
                        ...
                        <a href="book.php" class="btn btn-primary">رجوع </a>                             
                               </div>
                           </div>
                            </div>
                    <!--/.span3-->
