                            ...
                            ?>
                                    ...
                                    <tr>
                                      ...
                                      <td><?php echo $duedate ?></td>
                                        ...
                                        <?php 
                                         if($renewals)
                                            echo "<a href=\"renew_request.php?id=".$bookid."\" class=\"btn btn-success\">تجديد</a>";
                                        ?>
                                        <a href="return_request.php?id=<?php echo $bookid; ?>" class="btn btn-primary">ارجاع</a>
                                        </center></td>
                                    </tr>
                            <?php }} ?>
                                    </tbody>
