    ...
    <body>
        ...
        <nav aria-label="breadcrumb" style="margin-top: -30px;margin-left: 30px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="message.php">الرسائل </li>
            </ol>
                    ...
                    <div class="span9"  style="text-align:right;">
                        <table class="table" id = "tables" dir="rtl">
                                  ...
                                  <tbody>
                                    <?php
                                    $rollno=$_SESSION['RollNo'];
                            $sql="Select * from LMS.message where RollNo='$rollno' and active = 1 order by Date DESC,Time DESC";
