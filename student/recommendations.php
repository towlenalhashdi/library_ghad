    ...
    <body>
        ...
        <nav aria-label="breadcrumb" style="margin-top: -30px;margin-left: 30px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="recommendations.php">توصيات الكتب</li>
            </ol>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="content">
                        ...
                        <div class="module" style="margin-top: -350px;margin-right: 40px;">
                            <div class="module-head" style="text-align:right;background-color: #1e7594;">
                                <h3> توصيات الكتاب </h3>
                            </div>
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="recommendations.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="Title"><b>عنوان الكتاب</b></label>
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="عنوان الكتاب" class="span8" required>
                                            </div>
                                        </div>
                                        
                                        <div class="control-group">
                                            <label class="control-label" for="Description"><b>التوصيف</b></label>
                                            <div class="controls">
                                                <input type="text" id="Description" name="Description" placeholder="التوصيف" class="span8" required>
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" name="submit"class="btn">ارسال التوصية</button>
                                            </div>
                                        </div>
                                    </form>
                            </div>
...
echo "<script type='text/javascript'>alert('تم ارسال التوصية بنجاح')</script>";
}
else
{//echo $conn->error;
