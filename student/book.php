                        ...
                        <table class="table" id = "tables"dir="rtl">
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td width="100px"><b><?php 
                                           if($avail > 0)
                                              echo "<font color=\"green\">متوفر</font>";
                                            else
                                            	echo "<font color=\"red\"> غير متوفر</font>";

                                                 ?>
                                                 	
                                                 </b></td>
                                      <td ><a href="bookdetails.php?id=<?php echo $bookid; ?>" class="btn btn-primary">تفاصيل</a>
                                      
                                      	<?php
                                      	if($avail > 0)
                                      		echo "<a href=\"issue_request.php?id=".$bookid."\" class=\"btn btn-success\">اعارة</a>";
                                        ?>
                                        <a href="download.php?id=<?php echo $bookid; ?>" class="btn btn-primary">تحمل/قراءة</a>
                                        </td>
                                    </tr>
                               <?php }} ?>
                               </tbody>
